      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <AnimatePresence>
          {(!isMobile || sidebarOpen) && (
            <motion.aside
              key="sidebar"
              initial={isMobile ? { x: '-100%' } : { x: -20, opacity: 0 }}
              animate={isMobile ? { x: 0 } : { x: 0, opacity: 1 }}
              exit={isMobile ? { x: '-100%' } : { x: -20, opacity: 0 }}
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px' }}>
                ...
                <span style={{ fontWeight: 700, fontSize: '15px', letterSpacing: '-0.02em', flex: 1 }}>
                  DocMind <span className="gradient-text">AI</span>
                </span>
              ...
              <div style={{ marginTop: 'auto' }}>
                <AnimatePresence>
                  {showDropZone ? (
                    ...
                    >
                      <DropZone onDocumentLoaded={(doc) => { onChangeDocument(doc); if (isMobile) setSidebarOpen(false); }} compact />
                      <button
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
          ...
          {!isMobile && (
            ...
            >
              <div style={{ flex: 1, minWidth: 0 }}>
                <h2 style={{ fontSize: '15px', fontWeight: 600, color: 'var(--text)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
          ...
          {/* Mobile sub-header (doc info + model) */}
          {isMobile && (
            <div
              style={{
                padding: '10px 16px',
            ...
            >
              <p style={{ fontSize: '12px', color: 'var(--text-muted)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', flex: 1 }}>
                <span style={{ color: 'var(--purple-light)', fontWeight: 600 }}>{document.name}</span>
                {' · '}
              ...
              {(() => {
                ...
                return (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '5px', flexShrink: 0 }}>
                    <span style={{ width: 6, height: 6, borderRadius: '50%', background: m.color, display: 'inline-block', boxShadow: `0 0 5px ${m.color}88` }} />
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ fontSize: '13px', color: 'var(--text-muted)', maxWidth: '280px' }}>
                    ...
                    {isMobile ? ' Tap ☰ for suggestions.' : ' Try one of the suggested questions or type your own.'}
                  </p>
                </div>
              </motion.div>
            )}
          ...
          >
            <div
              style={{
                ...
                border: '1px solid var(--border)',
                borderRadius: '16px',
                padding: isMobile ? '10px 10px 10px 14px' : '12px 12px 12px 16px',
